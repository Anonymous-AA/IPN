...
save_dir=./logs/IPN-${dataset}/Consistency.${consistency_type}.${consistency_coef}-C${clusters}-${loss_type}-R-${r_net}.C-${c_net}-N${class_per_it}-K${num_shot}-LR${lr}-WD${weight_decay}

CUDA_VISIBLE_DEVICES=${gpus} python exps/main.py \
